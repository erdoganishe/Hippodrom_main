namespace IS_Hyppodrom
{
    partial class AutoBetForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Для того, щоб зробіть ставку, перейдіть за посиланням та заповніть форму.";
            // 
            // button1
            // 
            ...
            this.button1.Text = "Перейти за посиланням";
            ...
            this.label2.Text = "Після того, як форма буде заповнена та відправлена, натисність кнопку підтверджен" +
    "ня.";
            // 
            // label3
            // 
            ...
            this.Name = "AutoBetForm";
            this.Text = "AutoBetForm";
